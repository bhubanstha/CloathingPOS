...
namespace POSSystem.WPF.UI.Controls
{
    public class AutoCompleteTextBox : TextBox
    {
        ...
        public static readonly DependencyProperty AutoCompleteColumnsProperty = 
            DependencyProperty.Register("AutoCompleteColumns", typeof(ObservableCollection<DataGridColumn>), typeof(AutoCompleteTextBox));

        public static readonly DependencyProperty AutoCompleteItemSourceProperty = 
            DependencyProperty.Register("AutoCompleteItemSource", typeof(IEnumerable<object>), typeof(AutoCompleteTextBox));

        public static readonly DependencyProperty SelectedItemProperty = 
            DependencyProperty.Register("SelectedItem", typeof(object), typeof(AutoCompleteTextBox));

        public static readonly DependencyProperty AutoCompletePlacementDependencyProperty = 
            DependencyProperty.Register("AutoCompletePlacement", typeof(PlacementMode), typeof(AutoCompleteTextBox));

        public static readonly DependencyProperty AutoCompletePlacementTargetDependencyProperty =
            DependencyProperty.Register("AutoCompletePlacementTarget", typeof(UIElement), typeof(AutoCompleteTextBox));

        public static readonly DependencyProperty AutoCompleteHorizontalOffsetDependencyProperty = 
            DependencyProperty.Register("AutoCompleteHorizontalOffset", typeof(double), typeof(AutoCompleteTextBox));

        public static readonly DependencyProperty AutoCompleteVerticalOffsetDependencyProperty = 
            DependencyProperty.Register("AutoCompleteVerticalOffset", typeof(double), typeof(AutoCompleteTextBox));

        public static readonly DependencyProperty AutoCompleteWidthDependencyProperty = 
            DependencyProperty.Register("AutoCompleteWidth", typeof(double), typeof(AutoCompleteTextBox));

        public static readonly DependencyProperty AutoCompleteHeightDependencyProperty = 
            DependencyProperty.Register("AutoCompleteHeight", typeof(double), typeof(AutoCompleteTextBox));
