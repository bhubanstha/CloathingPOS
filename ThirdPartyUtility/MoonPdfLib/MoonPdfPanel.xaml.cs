...
namespace MoonPdfLib
{
    public partial class MoonPdfPanel : UserControl
    {
        ...
        public void Print()
        {
            //This helper function doesn't work
            //PrintPdfFile.SendFileToPrinter(this.pdfFileName);


            //To print pdf document Adobe reader needs to be installed
            //else print won't work as most printer doesn't support pdf direct printing
